...
import {FindAllBody, FindAllResponse, FindOneQuery, SearchBody} from './CurdBaseDefine'
import {CurdBaseServices} from './CurdBaseServices'


export class CurdBaseController<T extends ObjectLiteral = any> {
    protected _services: CurdBaseServices<T>;
    ...
    protected constructor(_services: CurdBaseServices<T>) {
